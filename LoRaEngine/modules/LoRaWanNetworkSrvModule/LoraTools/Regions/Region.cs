...
namespace LoRaTools.Regions
{
    ...
    public class Region
    {
        ...
        /// </summary>
        public Dictionary<ushort, (DR datarate, uint maxPyldSize)> DRtoConfiguration { get; set; } = new Dictionary<ushort, (DR, uint)>();
    ...
    public class DR
        ...
        public override string ToString() => $"SF{this.SF}BW{this.BW}";
    }
}
